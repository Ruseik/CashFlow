...
<div class="card shadow-sm">
    <div class="card-body">
        <form method="POST" action="/currencies" class="needs-validation" novalidate>
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
            <div class="mb-3">
                <label for="code" class="form-label">Code</label>
                <input type="text" class="form-control <?= isset($_SESSION['errors']['code']) ? 'is-invalid' : '' ?>" id="code" name="code" value="<?= htmlspecialchars($_SESSION['old']['code'] ?? '') ?>" required maxlength="5">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="symbol" name="symbol" value="<?= htmlspecialchars($_SESSION['old']['symbol'] ?? '') ?>">
            </div>
